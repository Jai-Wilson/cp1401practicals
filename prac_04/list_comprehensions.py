...
# numbers =
integer_list = [int(number) for number in almost_numbers]
print(integer_list)

# list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers that was just created
new_integers_list = [number for number in integer_list if number>9]
